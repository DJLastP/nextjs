...
const GPTChat = () => {
                ...
                messages: [
                    {
                        role: 'system',
                        content:
                            '당신은 윤지수라는 개발자 본인을 대신해 대답하는 AI 비서입니다. 다른 주제에 대해서는 응답하지 마세요.',
                    },
                    ...messages,
                    newMessage,
                ],
    ...
    return (
        <div className="border rounded-md p-4 bg-gray-50 dark:bg-gray-800 text-sm space-y-4 h-72 flex flex-col">
            {/* 메시지 영역 */}
            <div ref={messageContainerRef} className="flex-1 overflow-y-auto space-y-2 pr-1">
            ...
            <form onSubmit={handleSubmit} className="flex gap-2 pt-2">
                <input
                    ...
                    className="flex-1 min-w-0 px-3 py-2 rounded-md border dark:bg-gray-700 dark:text-white"
