    ...
    return (
        <section id={'home'} className={'flex flex-col md:flex-row justify-between items-center mb-12'}>
            ...
            <div className={'text-center md:text-right'}>
                ...
                <p className="text-xl mb-4 dark:text-gray-100">풀스택 개발자</p>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    안녕하세요. 3년차 풀스택 개발자 <strong className="font-semibold text-gray-800 dark:text-white">윤지수</strong>입니다. <br/>
                    ...
                    TensorFlow로 간단한 머신러닝 모델을 학습시켜 본 경험도 있습니다. <br/>
                </p>
            </div>
        </section>
    );
